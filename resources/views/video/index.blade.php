...
@endif
  ...
  <div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header">ข้อมูลVideo</div>
          <div class="card-body">
              ...
              <table id="myTable">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{ ++$k }}</td>
                    <td>
                        <iframe width="200" height="150" src="{{$items->url}}" frameborder="0"></iframe>
                    ...
                    <td class="text-center" width="20%">
                        @if($min == $items->seq)
                            <button
                                ...
                                data-name="video" data-no="{{ $items->seq }}"
                                data-popup="tooltip"
                    ...
                    <td>
                        <a href="{{ url('/admin/video/' . $items->id . '/edit') }}" class="btn btn-warning editmdi btn-edit">แก้ไข</a>
