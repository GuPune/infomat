...
@endif
  ...
  <div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header">ข้อมูลผลิตภัณฑ์</div>
          <div class="card-body">
              ...
              <table id="myTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center" width="20%">
                        @if($min == $items->seq)
                            <button
                                ...
                                data-name="product" data-no="{{ $items->seq }}"
                                data-popup="tooltip"
                    ...
                    <td>
                        <a href="{{ url('/admin/product/' . $items->id . '/edit') }}" class="btn btn-warning editmdi btn-edit">แก้ไข</a>
